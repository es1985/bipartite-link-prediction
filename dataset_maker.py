...
def reviews_iterator(path='/home/evgeny/Documents/Master thesis/Yelp\'s Dataset challenge/data/provided/yelp_academic_dataset_review.json'):
...
def make_dataset(t1, t2, out_dir):
    ...
    write_node_data(lambda user_data: id_to_nid['u' + user_data['user_id']], nids,
                    '/home/evgeny/Documents/Master thesis/Yelp\'s Dataset challenge/data/provided/yelp_academic_dataset_review.json',
                    out_dir + 'user.json')
...
if __name__ == '__main__':
    make_dataset(datetime.date(2012, 1, 1), datetime.date(2012, 7, 1), '/home/evgeny/Documents/Master thesis/Yelp\'s Dataset challenge/data/train/')
    make_examples('/home/evgeny/Documents/Master thesis/Yelp\'s Dataset challenge/data/train/', n_users=10000, min_degree=1, negative_sample_rate=0.01,
                  min_active_time=datetime.date(2011, 7, 1), new_edge_only=False)

    make_dataset(datetime.date(2013, 1, 1), datetime.date(2013, 7, 1), '/home/evgeny/Documents/Master thesis/Yelp\'s Dataset challenge/data/test/')
    make_examples('/home/evgeny/Documents/Master thesis/Yelp\'s Dataset challenge/data/test/', n_users=10000, min_degree=1, negative_sample_rate=0.01,
